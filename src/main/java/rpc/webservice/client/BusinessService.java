 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://webservice.business/client", wsdlLocation = "http://localhost:8084/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.business/client", "BusinessService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/BusinessService?wsdl");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://webservice.business/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.business/client", "BusinessPort"), Business.class, features);
    }
